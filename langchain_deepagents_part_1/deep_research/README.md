...
```bash
export DEEPSEEK_API_KEY=sk-c045276d62aa4d00bc71f000ec925497  # Required for Claude model
export TAVILY_API_KEY=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       # Required for web search ([get one here](https://www.tavily.com/)) with a generous free tier
